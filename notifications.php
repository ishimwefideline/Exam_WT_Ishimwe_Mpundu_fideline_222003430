...
<form action="" method="POST" onsubmit="return confirmInsert();">
    <h3 style="font-size: 20px;color: deeppink;"><i>NOTIFICATION FORM</i></h3>
    ...
    <input type="time" id="Timestamp" name="Timestamp" required><br><br>
...
if(isset($_POST['send'])) {
    ...
    $stmt = $connection->prepare("INSERT INTO notifications (NotificationID, UserID, NotificationType, Timestamp) VALUES (?, ?, ?, ?)");

    $stmt->bind_param("isss", $NotificationID, $UserID, $NotificationType, $Timestamp);
