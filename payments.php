...
<form action="" method="POST" onsubmit="return confirmInsert();">
    <h3 style="font-size: 20px;color: deeppink;"><i>PAYMENTS FORM</i></h3>
...
if(isset($_POST['send'])) {
    ...
    $stmt = $connection->prepare("INSERT INTO Payments (PaymentID, UserID, Amount, PaymentDate, PaymentMethod) VALUES (?, ?, ?, ?, ?)");

    $stmt->bind_param("issss", $PaymentID, $UserID, $Amount, $PaymentDate, $PaymentMethod);
