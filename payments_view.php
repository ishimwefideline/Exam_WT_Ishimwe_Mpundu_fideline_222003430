        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                    ...
                    <td style='background-color:red'><a style='padding:4px' href='delete_payments.php?PaymentID=$PaymentID'>Delete</a></td> 
                    <td style='background-color:skyblue'><a style='padding:4px' href='payments_update.php?PaymentID=$PaymentID'>Update</a></td> 
                </tr>";
            }
        } else {
