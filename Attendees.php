...
<form action="" method="POST" onsubmit="return confirmInsert();">
    <h3 style="font-size: 20px;color: deeppink;"><i>ATTENDEES FORM</i></h3>
    <label for="AttendeeID">AttendeeID:</label>
    <input type="number" id="AttendeeID" name="AttendeeID"><br><br>
...
if(isset($_POST['send'])) {
    ...
    $stmt = $connection->prepare("INSERT INTO Attendees (AttendeeID, UserID, Fullname, Email) VALUES (?, ?, ?, ?)");

    $stmt->bind_param("isss", $AttendeeID, $UserID, $Fullname, $Email);
