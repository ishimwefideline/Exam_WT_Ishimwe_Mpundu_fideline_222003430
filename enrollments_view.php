        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                    ...
                    <td style='background-color:red'><a style='padding:4px' href='delete_enrollments.php?EnrollmentID=$EnrollmentID'>Delete</a></td> 
                    <td style='background-color:skyblue'><a style='padding:4px' href='enrollments_update.php?EnrollmentID=$EnrollmentID'>Update</a></td> 
                </tr>";
            }
        } else {
