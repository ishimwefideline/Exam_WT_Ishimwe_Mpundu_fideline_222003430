...
<form action="" method="POST" onsubmit="return confirmInsert();">
    <h3 style="font-size: 20px;color: deeppink;"><i>ENROLLMENT FORM</i></h3>
...
if(isset($_POST['send'])) {
    ...
    $stmt = $connection->prepare("INSERT INTO enrollments (EnrollmentID, AttendeeID, WorkshopID, EnrollmentDate) VALUES (?, ?, ?, ?)");

    $stmt->bind_param("isss", $EnrollmentID, $AttendeeID, $WorkshopID, $EnrollmentDate);
