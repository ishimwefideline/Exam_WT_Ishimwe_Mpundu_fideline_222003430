        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                    ...
                    <td style='background-color:red'><a style='padding:4px' href='delete_instructors.php?InstructorID=$InstructorID'>Delete</a></td> 
                    <td style='background-color:skyblue'><a style='padding:4px' href='Instructors_update.php?InstructorID=$InstructorID'>Update</a></td> 
                </tr>";
            }
        } else {
